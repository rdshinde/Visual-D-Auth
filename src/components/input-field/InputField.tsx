...
export const InputField = ({ labelName, inputType, mnemonicWord, index }: Props) => {
  ...
  return (
    <div className={`mb-6 w-full`}>
      <label htmlFor='default-input' className='block mb-1 text-lg font-bold text-blue text-left'>
      ...
      />
      <span
        className={`block my-1 mx-1 font-bold text-sm ${isWordValid ? 'text-green-500' : 'text-orange'} text-start`}
        aria-hidden
        tabIndex={-1}
      >
